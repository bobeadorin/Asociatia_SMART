  ...
  return (
    <article className="termsAndConditions-container">
      <section className="terms-content-wrapper">
        ...
        <h2 class="terms-titles">1. Informații Colectate</h2>
        <p class="terms-subTitles">
          <strong>Informații Personale:</strong>
        </p>
        <ul class="terms-text-wrapper">
          <li class="terms-normalText">Numele și prenumele</li>
          <li class="terms-normalText">Adresa de e-mail</li>
          <li class="terms-normalText">Numărul de telefon</li>
          <li class="terms-normalText">
        ...
        <ul class="terms-text-wrapper">
          <li class="terms-normalText">Adresa IP</li>
          <li class="terms-normalText">Dispozitivul și browser-ul utilizat</li>
          <li class="terms-normalText">Paginile vizitate pe site-ul nostru</li>
        </ul>

        <h2 class="terms-titles">2. Scopul Colectării Informațiilor</h2>
        <p class="terms-text-wrapper">
        ...
        <h2 class="terms-titles">3. Păstrarea și Securitatea Informațiilor</h2>
        <p class="terms-text-wrapper">
        ...
        <h2 class="terms-titles">4. Partajarea Informațiilor</h2>
        <p class="terms-text-wrapper">
        ...
        <h2 class="terms-titles">6. Cookie-uri și Tehnologii Similare</h2>
        <p class="terms-text-wrapper">
        ...
        <h2 class="terms-titles">8. Contact</h2>
        <p class="terms-text-wrapper">
          Dacă aveți întrebări sau preocupări cu privire la această politică de
          confidențialitate, vă rugăm să ne contactați la adresa{" "}
